      ...
      <footer className="bg-[var(--hey-black)] text-[var(--hey-cream)]">
        <div className="px-5 md:px-12 py-10 border-t border-white/10 flex flex-col md:items-center">
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-12 items-start md:justify-center">
            ...
            <a href="https://maps.app.goo.gl/jy6RyiFYTaArSK1g8" target="_blank" rel="noopener noreferrer" onClick={() => pushEvent({ event: "directions_click", page_path: typeof window !== "undefined" ? window.location.pathname : "" })} className="flex items-center gap-3 group">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[var(--hey-yellow)] group-hover:scale-110 transition-transform duration-200 flex-shrink-0">
              ...
              <div className="flex flex-col text-left">
                ...
                <span className="text-xs md:text-sm font-bold text-[var(--hey-yellow)] group-hover:underline">No. 18 Ramanashree, MG Road, Ashok Nagar, Bangalore</span>
              </div>
            </a>
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col text-left">
                ...
                <a href="tel:+918047250000" onClick={() => pushEvent({ event: "call_click", phone_number: "+918047250000", page_path: typeof window !== "undefined" ? window.location.pathname : "" })} className="text-xs md:text-sm text-[var(--hey-yellow)] hover:underline">080 4725 0000</a>
                <a href="tel:+918904085005" onClick={() => pushEvent({ event: "call_click", phone_number: "+918904085005", page_path: typeof window !== "undefined" ? window.location.pathname : "" })} className="text-xs md:text-sm text-[var(--hey-yellow)] hover:underline">089 0408 5005</a>
              </div>
            </div>
          </div>
        </div>
        <div className="border-t border-white/10 px-5 md:px-12 py-4 text-left md:text-center">
          <p className="text-xs text-[var(--hey-cream)]/50">Keen Mustard Ventures — Making Your Day Since 2022</p>
        </div>
      </footer>
    </>
  );
