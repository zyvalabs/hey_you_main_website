...
export function BottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-[var(--hey-black)] border-t border-white/10 flex items-center justify-around px-2 py-1.5">
      ...
      <Link to="/reserve" search={{ venue: null } as any} className={`flex flex-col items-center gap-0.5 px-3 py-1 rounded-xl transition-all duration-200 ${location.pathname === '/reserve' ? 'text-[var(--hey-yellow)]' : 'text-[var(--hey-cream)]/60'}`}>
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
