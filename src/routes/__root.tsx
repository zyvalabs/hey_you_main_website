...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Heyou" },
      { name: "description", content: "Pixel Perfect UI is a web application that replicates PDF designs into responsive web interfaces." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Heyou" },
      { property: "og:description", content: "Pixel Perfect UI is a web application that replicates PDF designs into responsive web interfaces." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Heyou" },
      { name: "twitter:description", content: "Pixel Perfect UI is a web application that replicates PDF designs into responsive web interfaces." },
