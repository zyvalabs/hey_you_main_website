  ...
  createRootRouteWithContext<{ queryClient: QueryClient }>()({
    head: () => ({
      meta: [
        ...
        {
          name: "description",
          content: "Heyou. Come for one round. Stay for dinner.",
        },
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-K2BPMX7T');`,
          }}
        />
      ...
      <body>
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-K2BPMX7T"
            height="0"
            width="0"
